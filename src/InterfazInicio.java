        ...
        Galeria galeria = new Galeria();
        {
            ...
            while (continuar) {
                try {
                    ...
                    galeria.cargarInformacionOtros();
                    galeria.cargarInformacionCliente();
                    galeria.cargarInformacionEmpleado();
                    galeria.cargarInformacionCondicionesCategoria();
                    galeria.cargarInformacionSeguros();
                    galeria.cargarInformacionSedes();
                    galeria.cargarInformacionSedesOtras();
                    galeria.cargarAdminSedes();
